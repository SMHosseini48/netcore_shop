...
{
    public partial class first112 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FileName = table.Column<string>(type: "nvarchar(max)", nullable: true, computedColumnSql: "concat('Image_',[Id],'_',[ProductId],'_',getdate())"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_ShoppingCartRecords_Id_ProductId_CustomerId", x => new { x.Id, x.ProductId, x.CustomerId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "0266550d-b346-400b-ae70-e77d43d3452e", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { 2, "41b0f71c-efdb-464f-a8e7-02b0e90b1b52", "Customer", "CUSTOMER" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { 1, 0, "aa8bbda4-aa6d-48ad-9460-7ec3ef3d3bc1", "admin@example.com", true, "Admin", "Admin", false, null, "ADMIN@EXAMPLE.COM", "ADMIN@EXAMPLE.COM", "AQAAAAEAACcQAAAAEJwqzZr77exJ4D2G6AtTlnVGw57hJLDbW/7TPvNavU9ewaB2IydZKpmDa0F4znojqw==", null, false, "00000000-0000-0000-0000-000000000000", false, "admin@example.com" });
